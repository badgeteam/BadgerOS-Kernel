...
pub mod efer {
    ...
    pub const SCE_MASK: u64 = 1 << 0;
    /// EFER: Long mode enable.
    pub const LME_MASK: u64 = 1 << 8;
    /// EFER: Long mode active.
    pub const LMA_MASK: u64 = 1 << 9;
    /// EFER: No-execute enable.
    pub const NXE_MASK: u64 = 1 << 10;
    /// EFER: Secure virtual machine enable.
    pub const SVME_MASK: u64 = 1 << 11;
    /// EFER: Fast FXSAVE/FXSTOR.
    pub const FFXSR_MASK: u64 = 1 << 12;
    /// EFER: Translation cache extension.
    pub const TCE_MASK: u64 = 1 << 13;
}
